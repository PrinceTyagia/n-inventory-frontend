    ...
    <section className="w-full py-20 bg-blue-50/50">
      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <Tabs  defaultValue="product-catalog" className="w-full">
          {/* Tab Buttons */}
          <TabsList  className="flex items-center w-full gap-2 bg-white/50 backdrop-blur-sm p-2 rounded-full h-16 shadow-sm mb-8 flex-wrap justify-center">
            {features.map((feature) => {
              ...
              return (
                <TabsTrigger
                  key={feature.id}
                  value={feature.id}
                  className="flex items-center justify-center gap-2 px-2 py-2.5 rounded-full data-[state=active]:bg-teal-100 data-[state=active]:text-teal-900 transition-all duration-300 text-slate-600"
                >
