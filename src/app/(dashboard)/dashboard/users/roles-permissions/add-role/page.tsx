...
import { usePostRoleByOrgMutation } from "@/hooks/Api/role/roleHook";
...
const PermissionModuleList: React.FC = () => {
  ...
  const [postRoleByOrg, { isLoading, isSuccess, error }] =
    usePostRoleByOrgMutation();
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await postRoleByOrg(payload).unwrap();
      if(res.success){
